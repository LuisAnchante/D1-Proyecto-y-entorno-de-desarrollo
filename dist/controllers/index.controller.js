...
exports.renderNewEntryPage = exports.renderIndexPage = exports.renderAlonsoPage = exports.renderAboutPage = exports.deleteBook = exports.createNewEntry = void 0;
...
var renderAlonsoPage = function renderAlonsoPage(req, res) {
  return res.render("alonso", {
    books: books
  });
};

exports.renderAlonsoPage = renderAlonsoPage;
